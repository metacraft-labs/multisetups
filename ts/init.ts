...
import { computeB3sum, FORMAT, getZkeyFiles, S3_BUCKET, validateZkeyDir } from './utils'
...
const init = async (
    ...
    console.log('Ceremony initialised. Please give this root to the first participant.')
    console.log(root)
